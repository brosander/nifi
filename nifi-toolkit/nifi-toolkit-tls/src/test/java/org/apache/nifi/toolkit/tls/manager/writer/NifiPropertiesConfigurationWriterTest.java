...
public class NifiPropertiesConfigurationWriterTest {
    @Mock
    ...
    private NifiPropertiesConfigurationWriter nifiPropertiesConfigurationWriter;
    ...
    public void setup() throws IOException {
        ...
        nifiPropertiesConfigurationWriter = new NifiPropertiesConfigurationWriter(niFiPropertiesWriterFactory, outputFile, testHostname, hostNum);
        overlayProperties = nifiPropertiesConfigurationWriter.getOverlayProperties();
    }

    @Test
    public void testDefaults() throws IOException {
        nifiPropertiesConfigurationWriter.write(tlsClientConfig, outputStreamFactory);
        testHostnamesAndPorts();
        assertNotEquals(0, nifiPropertiesConfigurationWriter.getIncrementingPropertyMap().size());
    }

    @Test(expected = NumberFormatException.class)
    public void testBadPortNum() throws IOException {
        nifiPropertiesConfigurationWriter.getOverlayProperties().setProperty(nifiPropertiesConfigurationWriter.getIncrementingPropertyMap().keySet().iterator().next(), "notAnInt");
        nifiPropertiesConfigurationWriter.write(tlsClientConfig, outputStreamFactory);
    }

    @Test
    public void testNoHostnameProperties() throws IOException {
        nifiPropertiesConfigurationWriter.getOverlayProperties().setProperty(NifiPropertiesConfigurationWriter.HOSTNAME_PROPERTIES, "");
        nifiPropertiesConfigurationWriter.write(tlsClientConfig, outputStreamFactory);
        testHostnamesAndPorts();
    ...
    private void testHostnamesAndPorts() {
        ...
        assertEquals(NifiPropertiesConfigurationWriter.CONF + keyStore, nifiProperties.getProperty(NiFiProperties.SECURITY_KEYSTORE));
        ...
        assertEquals(NifiPropertiesConfigurationWriter.CONF + trustStore, nifiProperties.getProperty(NiFiProperties.SECURITY_TRUSTSTORE));
        ...
        nifiPropertiesConfigurationWriter.getHostnamePropertyStream().forEach(s -> assertEquals(testHostname, nifiProperties.getProperty(s)));
        nifiPropertiesConfigurationWriter.getIncrementingPropertyMap().entrySet().forEach(propertyToPortEntry -> {
