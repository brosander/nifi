 ...
 */
public class CertificateAuthorityClientCommandLine extends BaseCertificateAuthorityCommandLine {
    ...
    public static final OptionWithDefault CERTIFICATE_DIRECTORY_OPTION = new OptionWithDefault("C", CERTIFICATE_DIRECTORY, "The file to write the CA certificate to", DEFAULT_CERTIFICATE_DIRECTORY);

    private final Logger logger = LoggerFactory.getLogger(CertificateAuthorityClientCommandLine.class);
    private final InputStreamFactory inputStreamFactory;

    private String certificateDirectory;

    public CertificateAuthorityClientCommandLine() {
        this(FileInputStream::new);
    }

    public CertificateAuthorityClientCommandLine(InputStreamFactory inputStreamFactory) {
        super(DESCRIPTION);
        this.inputStreamFactory = inputStreamFactory;
        addOption(CERTIFICATE_DIRECTORY_OPTION.getOption());
    }

    public static void main(String[] args) throws Exception {
        TlsHelper.addBouncyCastleProvider();
        CertificateAuthorityClientCommandLine tlsCertificateAuthorityClientCommandLine = new CertificateAuthorityClientCommandLine();
        try {
    ...
    protected CommandLine doParse(String[] args) throws CommandLineParseException {
        ...
        certificateDirectory = CERTIFICATE_DIRECTORY_OPTION.getValue(commandLine);
        return commandLine;
    }
