...
package org.apache.nifi.toolkit.tls.ca.remote.dto;

import org.apache.nifi.util.StringUtils;

public class RemoteCertificateAuthorityResponse {
    private byte[] hmac;
    private String pemEncodedCertificate;
    private String error;

    public RemoteCertificateAuthorityResponse() {
    }

    public RemoteCertificateAuthorityResponse(byte[] hmac, String pemEncodedCertificate) {
        this.hmac = hmac;
        this.pemEncodedCertificate = pemEncodedCertificate;
    }

    public RemoteCertificateAuthorityResponse(String error) {
        this.error = error;
    }
