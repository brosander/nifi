...
public class TlsCertificateSigningRequestPerformer {
    ...
    public X509Certificate[] perform(ObjectMapper objectMapper, KeyPair keyPair) throws NoSuchAlgorithmException, KeyStoreException, KeyManagementException,
            OperatorCreationException, IOException, CertificateException, InvalidKeyException, NoSuchProviderException, SignatureException, CRMFException {
