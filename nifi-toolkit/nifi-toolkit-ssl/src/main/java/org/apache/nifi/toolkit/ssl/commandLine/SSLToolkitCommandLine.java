...
public class SSLToolkitCommandLine {
    ...
    public SSLToolkitCommandLine(SecureRandom secureRandom) {
    ...
    public <T> T printUsageAndThrow(String errorMessage, int exitCode) throws SSLToolkitParseException {
        printUsage(errorMessage);
        throw new SSLToolkitParseException(errorMessage, exitCode);
    }

    public void parse(String... args) throws SSLToolkitParseException {
    ...
    private List<String> getPasswords(String arg, CommandLine commandLine, int numHosts) throws SSLToolkitParseException {
        String[] optionValues = commandLine.getOptionValues(arg);
        if (optionValues == null) {
            return IntStream.range(0, numHosts).mapToObj(operand -> generatePassword()).collect(Collectors.toList());
        }
    ...
    private List<String> getKeyPasswords(CommandLine commandLine, List<String> keyStorePasswords) throws SSLToolkitParseException {
