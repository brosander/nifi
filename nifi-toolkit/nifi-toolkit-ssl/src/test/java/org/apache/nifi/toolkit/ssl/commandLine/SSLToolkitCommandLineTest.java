...
public class SSLToolkitCommandLineTest {
    ...
    public void testGeneratePassword() {
        ...
        String actual = sslToolkitCommandLine.generatePassword();
    ...
    public void testHelp() {
        ...
        } catch (SSLToolkitParseException e) {
    ...
    @Test
    public void testKeyAlgorithm() throws SSLToolkitParseException {
    ...
    @Test
    public void testKeySize() throws SSLToolkitParseException {
    ...
    @Test
    public void testSigningAlgorithm() throws SSLToolkitParseException {
    ...
    @Test
    public void testDays() throws SSLToolkitParseException {
        int testDays = 29;
    ...
    @Test
    public void testKeyStoreType() throws SSLToolkitParseException {
    ...
    @Test
    public void testOutputDirectory() throws SSLToolkitParseException {
    ...
    @Test
    public void testHostnames() throws SSLToolkitParseException {
        String nifi1 = "nifi1";
        String nifi2 = "nifi2";
    ...
    @Test
    public void testHttpsPort() throws SSLToolkitParseException {
    ...
    @Test
    public void testNifiPropertiesFile() throws SSLToolkitParseException, IOException {
    ...
    @Test
    public void testNifiPropertiesFileDefault() throws SSLToolkitParseException, IOException {
    ...
    @Test
    public void testNotSameKeyAndKeystorePassword() throws SSLToolkitParseException {
        sslToolkitCommandLine.parse();
    ...
    @Test
    public void testSameKeyAndKeystorePassword() throws SSLToolkitParseException {
    ...
    @Test
    public void testSameKeyAndKeystorePasswordWithKeystorePasswordSpecified() throws SSLToolkitParseException {
    ...
    @Test
    public void testKeyStorePasswordArg() throws SSLToolkitParseException {
        String testPassword = "testPassword";
    ...
    @Test
    public void testMultipleKeystorePasswordArgs() throws SSLToolkitParseException {
    ...
    @Test
    public void testKeyPasswordArg() throws SSLToolkitParseException {
        String testPassword = "testPassword";
    ...
    @Test
    public void testMultipleKeyPasswordArgs() throws SSLToolkitParseException {
        String testPassword1 = "testPassword1";
        String testPassword2 = "testPassword2";
    ...
    @Test
    public void testTruststorePasswordArg() throws SSLToolkitParseException {
        String testPassword = "testPassword";
    ...
    @Test
    public void testMultipleTruststorePasswordArgs() throws SSLToolkitParseException {
        String testPassword1 = "testPassword1";
        String testPassword2 = "testPassword2";
