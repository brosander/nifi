...
Once the user has logged in or if they are accessing NiFi using a client pemEncodedCertificate loaded in their browser, they will be prompted
...
user is using a client pemEncodedCertificate, they will be immediately sent to the form to request access bypassing the canvas and login form.
